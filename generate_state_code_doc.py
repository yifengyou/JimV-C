...
print('|:--:|:--|:--|')
for k, v in list(OrderedDict(sorted(list(ji.index_state['trunk'].items()), key=lambda t: t[0])).items()):
...
print('|CODE|zh-cn|')
print('|:--:|:--|')
for k, v in list(OrderedDict(sorted(list(ji.index_state['branch'].items()), key=lambda t: t[0])).items()):
