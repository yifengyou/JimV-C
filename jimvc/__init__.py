...
from jimvc.api.reserved_ip import blueprint as reserved_ip_blueprint
from jimvc.api.reserved_ip import blueprints as reserved_ip_blueprints
...
from jimvc.api.misc import blueprint as misc_blueprint
from jimvc.api.misc import blueprints as misc_blueprints
...
try:
    ...
    app.register_blueprint(reserved_ip_blueprint)
    app.register_blueprint(reserved_ip_blueprints)
    ...
    app.register_blueprint(misc_blueprints)
